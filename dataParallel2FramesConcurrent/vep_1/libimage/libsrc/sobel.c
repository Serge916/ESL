...
void sobel(uint8_t const volatile *const frame_in, uint32_t const xsize_in, uint32_t const ysize_in, uint32_t const block_ysize, uint32_t const bitsperpixel_in,
                   ...
                   uint8_t const threshold, uint8_t volatile *const frame_out)
{
  ...
  sobel(frame, xsize_in, ysize_in, ysize_in, bitsperpixel, threshold, frame_sobel, 0);
