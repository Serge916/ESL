...
extern void convolution(uint8_t const volatile *const frame_in, uint32_t const xsize_in, uint32_t const ysize_in, uint32_t const volatile block_ysize, uint32_t const bitsperpixel_in,
                        double const *const f, uint32_t const fxsize, uint32_t const fysize, uint8_t volatile *const frame_out, uint32_t frame_half);
...
extern void sobel(uint8_t const volatile *const frame_in, uint32_t const xsize_in, uint32_t const ysize_in, uint32_t const block_ysize, uint32_t const bitsperpixel_in,
                  uint8_t const threshold, uint8_t volatile *const frame_out, uint32_t const frame_half);
