...
vep_tile3_partition2_shared_region_t volatile *const vep_tile3_partition2_shared_region = (vep_tile3_partition2_shared_region_t volatile *)VEP_TILE3_PARTITION2_SHARED_REGION_REMOTE_START;
_Static_assert(sizeof(vep_tile3_partition2_shared_region_t) <= VEP_TILE3_PARTITION2_SHARED_REGION_SIZE, "vep_tile3_partition2_shared_region does not fit in the VEP_TILE3_PARTITION2_SHARED_REGION");
#endif
