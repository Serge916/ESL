...
uint32_t const vep_memories_shared_remote_start[NUM_SHARED_MEMORIES][NUM_PARTITIONS]= {
  { NOT_SHARED, 0x80010000, NOT_SHARED, NOT_SHARED, },
  { NOT_SHARED, 0x90010000, NOT_SHARED, NOT_SHARED, },
  { NOT_SHARED, 0xA0010000, NOT_SHARED, NOT_SHARED, },
...
uint32_t const vep_memories_shared_remote_size[NUM_SHARED_MEMORIES][NUM_PARTITIONS]= {
  { NOT_SHARED, 0x00010000, NOT_SHARED, NOT_SHARED, },
  { NOT_SHARED, 0x00010000, NOT_SHARED, NOT_SHARED, },
  { NOT_SHARED, 0x00010000, NOT_SHARED, NOT_SHARED, },
