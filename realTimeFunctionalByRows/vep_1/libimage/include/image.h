...
extern void convolution(uint8_t const volatile *const *const lines_in, uint32_t const volatile length, uint32_t const volatile y_position, uint32_t const volatile y_size,
...
extern void sobel(uint8_t const volatile *const *const lines_in, uint32_t const length, uint32_t const y_position, uint32_t const y_size,
